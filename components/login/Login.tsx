...
export function Login() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        dispatch(login(formData))
            ...
            console.log(l);
            if (l === "Please verify your email first.") {
                route.replace("/verify-email?email=" + encodeURIComponent(formData.email));
            }
        })
            .finally(() => {
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        >
                            <div className="flex gap-2 items-center justify-center">
                                <Image src={"/google-icon.webp"} alt="google" height={20} width={20}
                                       className="size-8 "/>
