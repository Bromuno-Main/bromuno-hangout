    ...
    return (
        <div className="flex justify-start items-start h-full relative">
            <div className="w-full">
                <div className="flex-1 lg:h-[48px] mb-4  lg:gap-8 flex justify-between items-start lg:pt-2">
                    <div onClick={toggleModal} className="h-full border-b w-full flex items-end justify-start lg:pl-3 lg:pb-[7px]">
...
export function Answers() {
    ...
    return (
        <>
            ...
            <div className="w-full flex-col flex gap-4 py-4 outline">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="border-b w-full flex items-end ">
                            <input
                                ...
                                className={`p-2 !border-b flex-1 font-bold placeholder:font-medium Focus:border-transparent w-full focus:outline-none border-gray-200 ${question.length > 60 ? "!text-red-400" : ""
                                    }`}
                                required
                            />
                        ...
                        <span className="flex gap-3 items-center">
                            ...
                            <button
                                type="submit"
                                className={`w-full rounded-full text-black p-2 ${question.trim() && tags.trim() && question.length <= 60
