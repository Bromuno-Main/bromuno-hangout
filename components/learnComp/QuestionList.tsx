...
export default function QuestionList({tag, setShowAnswer, setId}: QuestionListProp) {
    const {questions, fetching, error} = useSelector((state: RootState) => state.question);
                            ...
                            .map((items, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            className="flex flex-col items-start justify-start mt-3 gap-2 text-black text-sm">
                                            {items.image &&
                                                <img className={`w-full h-[300px]`} src={items.image} alt=""/>}
