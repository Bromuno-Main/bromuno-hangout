    ...
    <>
      <div className="w-full h-full gap-4  flex flex-col ">
        <div className="flex gap-3 items-center justify-start">
          <p className="text-lg font-bold text-[#188268] border-b-[2px] border-b-[#188268]">Daily</p>
                ...
                <div className="lg:w-[426px] p-4 rounded-[12px] bg-[#FFF0DA] flex gap-4">
                 <div className="flex gap-4 items-center">
                  ...
                  <div className="w-[241px] h-[120px] py-[21px] px-3 gap-4 flex flex-col justify-between items-start">
                    ...
                    <p className="gap-4 flex items-center justify-between"><span className="text-lg font-bold">Jenifer</span> <span className="text-lg font-bold text-[#a3a3a3]">2 mins read</span></p>
                  </div>
                </div>
              </div>
