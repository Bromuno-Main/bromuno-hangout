...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 ",
  {
    variants: {
      variant: {
        default: "bg-[#F1F1F1] text-black hover:bg-black hover:text-white",
        dsn: "bg-[#EDD3FF] text-black text-sm hover:bg-black hover:text-[#EDD3FF] ",
        dev: "bg-[#FFE9D3] text-black text-sm hover:bg-black hover:text-[#FFE9D3] ",
        ghost: "border border-[#D9D9D9] text-black hover:bg-black hover:text-white ",
        link: "text-neutral-900 underline-offset-4 hover:underline dark:text-neutral-50",
      },
      size: {
        default: "h-[40px] w-[116px] px-6 py-3",
        sm: "w-[62px] gap-[6px] rounded-[24px] h-[22px] py-[2px] px-2",
