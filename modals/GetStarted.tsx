...
export default function GetStarted({ isOpen,  onClose }: AppProps) {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className={`inline-flex flex-col w-1/2 lg:py-10 gap-4 max-w-[500px]`}>
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="p-6">
                      <h1 className="text-2xl font-bold mb-4">Select with Search Filter</h1>
                            ...
                            {filteredOptions.length > 0 ? (
                              filteredOptions.map((option, index) => (
                                <li
                                  ...
                                  className={`px-4 py-2 cursor-pointer hover:bg-blue-100 ${selectedOption === option ? "bg-blue-50" : ""
                                    }`}
                                >
                                  {option}
                                </li>
